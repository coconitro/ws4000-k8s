...
# soft-recovery-attempted is cleared only when the display hash changes again
# (see check-ws4000-alive.sh) — clearing it here caused infinite soft-recover loops.
